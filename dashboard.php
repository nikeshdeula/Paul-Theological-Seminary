...
<div class="d-flex" id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <div class="sidebar-heading text-left py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"> <img src="./image/College logo.png" alt="">  <h6>  Paul <br> Theological <br> Seminary </h6></div>
